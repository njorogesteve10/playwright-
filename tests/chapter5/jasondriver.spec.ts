...
const typedDaata = testData as TestData;

for (const datawesekeys in typedDaata) {
    const skill = typedDaata[datawesekeys as keyof TestData];
    test.setTimeout(120000);

test(`first writing this before the millionth:${skill.skill1}`, async ({ browser }) => {
